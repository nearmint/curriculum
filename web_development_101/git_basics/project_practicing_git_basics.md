...
2. Open README.md in your text editor of choice. Open your home directory first. You can find the file in home/git_test/README.md. Once you have opened the file, add the text "This is (YourUsername)'s first git project!" and then save the file.
